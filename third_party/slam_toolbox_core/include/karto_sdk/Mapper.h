...
public:
   ...
   */
  LinkInfo()
  : m_ConstraintSource(ConstraintSource::Sequential)
  {
  }
  LinkInfo(
    const Pose2 & rPose1, const Pose2 & rPose2, const Matrix3 & rCovariance,
    ConstraintSource constraintSource = ConstraintSource::Sequential)
  : m_ConstraintSource(constraintSource)
  {
...
public:
  ...
  inline ConstraintSource GetConstraintSource() const
  {
...
private:
  ...
  void serialize(Archive & ar, const unsigned int version)
  {
    ...
    ar & BOOST_SERIALIZATION_NVP(m_ConstraintSource);
  }
};    // LinkInfo
